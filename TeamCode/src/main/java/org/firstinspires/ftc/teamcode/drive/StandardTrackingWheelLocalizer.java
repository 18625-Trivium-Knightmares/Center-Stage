...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.310911; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -3.0; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;

    public static double X_MULTIPLIER = 0.9285817461; // Multiplier in the X direction
