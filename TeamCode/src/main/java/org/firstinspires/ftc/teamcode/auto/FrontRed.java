...
@Autonomous (group = "AUTO", name = "Red Front Stage")
@Config
//@Disabled
public class FrontRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (randomization == Randomization.RIGHT) {
            ...
            Trajectory CURVE = drive.trajectoryBuilder(PURpLE_PIXEL.end(), true)
                    .addDisplacementMarker(() -> {
                        robot.resetChain();
                    ...
                    .splineToLinearHeading(new Pose2d(-25, -55, Math.toRadians(180)), Math.toRadians(0))
                    .build();

            Trajectory PaRK = drive.trajectoryBuilder(CURVE.end(), true)
            ...
            Trajectory PARK = drive.trajectoryBuilder(CURVE.end())
                    .splineTo(new Vector2d(10, -58), Math.toRadians(0))
                    .splineTo(new Vector2d(58, -9), Math.toRadians(0))
                    .build();
